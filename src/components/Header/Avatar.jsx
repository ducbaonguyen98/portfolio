...
const Avatar = () => {
  return (
    ...
    <div class="w-[250px] h-[180px] md:w-[350px] md:h-[220px] flex justify-center items-center">
      <div class="shadow w-[230px] h-[160px] md:w-[330px] md:h-[200px] bg-gradient-to-t from-white to-[#F0F2F5] dark:from-dark dark:to-[#414141] rounded-md flex justify-center items-center overflow-hidden">
        <img class="rounded-md md:self-start" src={require("../../images/avatar.png")} alt="avatar" />
      </div>
    </div> 
  );
};
